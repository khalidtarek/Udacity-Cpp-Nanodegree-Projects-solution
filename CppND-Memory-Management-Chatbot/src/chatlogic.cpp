...
ChatLogic::ChatLogic()
{
    ...
    // Nothing To do constructor shall be handled by smart pointer to alocate the space
...
ChatLogic::~ChatLogic()
{
    //// STUDENT CODE
    ////
    // Task 3 : Exclusive Ownership 2 -> Where required, make changes to the code such that data structures and function parameters reflect the changes.
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            // use make_unique poiunter to create new smart pointer instead of (new)
                            // Task 3 : Exclusive Ownership 2 -> Where required, make changes to the code such that data structures and function parameters reflect the changes.
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // use unique_pointer instead of normal pointer to handle nodes to handle node parent/child search
                            // Task 3 : Exclusive Ownership 2 -> Where required, make changes to the code such that data structures and function parameters reflect the changes.
                            ...
                            // create new edge
                            // Task 4 : Moving Smart Pointers -> hange the ownership of all instances of GraphEdge in a way such that each instance of GraphNode exclusively owns the outgoing GraphEdges 
                            ...
                            // Task 4 : Moving Smart Pointers -> make changes to the code such that data structures 
                            // and function parameters reflect the changes.
    ...
    ChatBot myLocalChatBot("../images/chatbot.png");
    _chatBot = &myLocalChatBot; 
    myLocalChatBot.SetChatLogicHandle(this);
    // add chatbot to graph root node
    myLocalChatBot.SetRootNode(rootNode);
    rootNode->MoveChatbotHere(std::move(myLocalChatBot));
