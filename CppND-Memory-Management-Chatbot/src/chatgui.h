...
private:
    ...
    //// STUDENT CODE
    ////
    // Task 1 : Exclusive Ownership-> make it unique pointer
...
public:
    ...
    // getter / setter
    // Task 1 : Exclusive Ownership -> make changes to the code such that data structures and function parameters reflect the new structure.
